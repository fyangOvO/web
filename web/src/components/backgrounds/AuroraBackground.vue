...
.aurora-5 {
  ...
  background: radial-gradient(circle, rgba(var(--accent-1-rgb), 0.3) 0%, rgba(var(--accent-2-rgb), 0.2) 50%, transparent 70%);
  animation: aurora-float-5 28s ease-in-out infinite;
}

.aurora-vignette {
  position: absolute; inset: 0;
  background: radial-gradient(ellipse at center, transparent 30%, rgba(0,0,0,0.04) 70%, rgba(0,0,0,0.12) 100%);
}
:global(.dark) .aurora-vignette {
  background: radial-gradient(ellipse at center, transparent 25%, rgba(0,0,0,0.15) 65%, rgba(0,0,0,0.35) 100%);
}
...
@keyframes aurora-float-1 { 0%,100% { transform: translate(0,0) scale(1); } 33% { transform: translate(8vw,6vh) scale(1.1); } 66% { transform: translate(-4vw,10vh) scale(0.95); } }
@keyframes aurora-float-2 { 0%,100% { transform: translate(0,0) scale(1); } 33% { transform: translate(-6vw,8vh) scale(1.08); } 66% { transform: translate(5vw,-4vh) scale(0.92); } }
@keyframes aurora-float-3 { 0%,100% { transform: translate(0,0) scale(1); } 50% { transform: translate(-8vw,-6vh) scale(1.12); } }
@keyframes aurora-float-4 { 0%,100% { transform: translate(0,0) scale(1); } 40% { transform: translate(10vw,-5vh) scale(1.05); } 70% { transform: translate(3vw,7vh) scale(0.95); } }
@keyframes aurora-float-5 { 0%,100% { transform: translate(0,0) scale(1); } 50% { transform: translate(-7vw,-8vh) scale(1.1); } }
